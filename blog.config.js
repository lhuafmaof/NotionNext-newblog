...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '令狐afmaof', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一条孤独游荡的产品狗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lhuafmaof.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '互联网,AI,Chatgpt,B端,工具产品,', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lhuafmaof@163.com', // 邮箱地址 例如mail@tangly1024.com
